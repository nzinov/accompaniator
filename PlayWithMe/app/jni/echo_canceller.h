...
// Using https://github.com/dakatso/SpeexExample/
...
JNIEXPORT void JNICALL Java_speex_EchoCanceller_reset
        (JNIEnv *env, jobject jObj);

JNIEXPORT bool JNICALL Java_speex_EchoCanceller_isOpen
        (JNIEnv *env, jobject jObj);
